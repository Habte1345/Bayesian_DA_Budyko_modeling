...
class TwoStoreModel_SCE:
    ...
    def parameters(self):
        return spotpy.parameter.generate([
            ...
            spotpy.parameter.Uniform(0.01, 1.0, name="Cqq"), # 10
...
if __name__ == "__main__":
    ...
    Rainf_df = pd.read_feather(os.path.join(DATA_DIR, "Rainf.feather")).set_index("Date")
    PotEvap_df = pd.read_feather(os.path.join(DATA_DIR, "PotEvap.feather")).set_index("Date")
    Q_usgs_df = pd.read_feather(os.path.join(DATA_DIR, "Q_USGS.feather")).set_index("Date")
